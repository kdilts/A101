...
displayAnswer = function(cellNum, answerNum){
	...
	addImage(path+'/C' + cellData[idx].solutionNum[answerNum] + 'anim.gif', 200, 200, 'position:absolute; left:460; top:200', 1);
}
...
enhance = function(){
	...
	addImage(path+'anim67enh5.gif',200,200,'position:absolute; left:360; top:120',1);
